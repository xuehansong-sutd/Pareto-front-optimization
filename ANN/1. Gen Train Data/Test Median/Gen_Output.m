...
%%
load Parameters.mat
load('FuncForm_Optics_median_device.mat');
load('FuncForm_Aug_median_device.mat');
load('FuncForm_Brad_median_device.mat');
load('FuncForm_tau_median_device.mat');
load('FuncForm_vII_median_device.mat');
load('FuncForm_vIII_median_device.mat');
...
f(:,i) = objectiveFcn(Parameter(:,i),Aug_median,Brad_median,tau_median,vII_median,vIII_median,xi_n);
i
end
