...
Output = load('Output_norm.txt');

Inputs = Parameter';
Targets = Output';
%% Setting up variables
hiddenLayerSizeRange_1 = [1 40];
hiddenLayerSizeRange_2 = [1 40];
optimVars = [optimizableVariable('Layer1Size',hiddenLayerSizeRange_1,'Type','integer')
             optimizableVariable('Layer2Size',hiddenLayerSizeRange_2,'Type','integer')
             optimizableVariable('TrainFcn1',{'logsig' 'tansig' 'compet' 'elliotsig'...
             'netinv' 'radbas' 'radbasn' 'softmax' 'tribas'},'Type','categorical')
             optimizableVariable('TrainFcn2',{'logsig' 'tansig' 'compet' 'elliotsig'...
             'netinv' 'radbas' 'radbasn' 'softmax' 'tribas'},'Type','categorical')];
